...
CREATE TABLE vets(
    ...
    Vet_account_ID_FK integer  not null,
    primary key(RUT),
...
CREATE TABLE vets_phones(
    Vet_phones_ID SERIAL not null,
    Vet_RUT_FK integer not null,
    Phone_ID_FK integer not null,
...
CREATE TABLE vets_addresses(
    Vet_address_ID SERIAL not null,
    Vet_RUT_FK integer not null,
...
CREATE TABLE users(
    ...
    Name varchar(30) not null,
    Surname varchar(30),
    User_account_ID_FK integer not null,
    primary key(RUT),
...
CREATE TABLE users_pets(
    Users_pets_ID SERIAL not null,
    User_RUT_FK integer not null,
    Pet_ID_FK integer  not null,
...
CREATE TABLE users_phones(
    User_phones_ID SERIAL not null,
    User_RUT_FK integer not null,
    Phone_ID_FK integer not null,
...
CREATE TABLE attention_records(
    Attention_record_ID SERIAL not null,
    Pet_ID_FK integer  not null,
    Vet_RUT_FK integer not null,
